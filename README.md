...
**357 production-ready Claude Code skills, plugins, and agent skills for 13 AI coding tools.**
...
[![Skills](https://img.shields.io/badge/Skills-357-brightgreen?style=for-the-badge)](#skills-overview)
...
Yes. All 597 Python CLI tools use the standard library only — zero pip installs required. Every script is verified to run with `--help`.
