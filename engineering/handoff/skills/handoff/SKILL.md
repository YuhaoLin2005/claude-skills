...
Before writing: scan for rationalizations ("I'll write it next session", "changes too small to audit"). See [references/rationalization_detection.md](references/rationalization_detection.md).
